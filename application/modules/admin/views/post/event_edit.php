<?php echo $form->messages();
    ...
    $university_post_id = $event_title = $event_link = $event_description  =  '';
      	...
      	<?php echo $form->open(); ?> 
	         ...
	         <div  class="col-sm-6">
	            <div class="">
	               ...
	               <input id="event_title" value="<?php echo $event_title ?>" name="event_title" type="text" placeholder="Enter event title" class="form-control input-md">
	            </div>
	         </div>
             ...
             <div  class="col-sm-6">
                <div class="">
                   ...
                   <input id="event_link" value="<?php echo $event_link ?>" name="event_link" type="text" placeholder="Enter event link" class="form-control input-md">
                </div>
             </div>
             ...
             <div  class="col-sm-6">
                <div class="">
                   ...
                   <input id="event_description" value="<?php echo $event_description ?>" name="event_description" type="text" placeholder="Enter event description" class="form-control input-md">
                </div>
             </div>
                    ...
                    <div class="row prepend_img">
                        ...
                        if (!empty($event_images))
                        {
                            ...
                            foreach ($image as $key => $value)
                            {
                                ...
                                echo '<div class="img_uploaded_glry" id="pic'.$index.'"><a  class="delt_optn_img" onclick="remove_pic(\''.$index.'\',\''.','.$value.'\')" ><i class="fa fa-trash-o" aria-hidden="true"></i></a><img src="'.$upload_dir.'/'.$value.'" class="img_uploded_thum" /></div>';
                                $index++;
                            }
                        }
