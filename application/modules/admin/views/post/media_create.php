<?php echo $form->messages();
    ...
    $university_post_id  = $caption  = $event_images =  '';
      	...
      	<?php echo $form->open(); ?> 
             ...
             <div  class="col-sm-6">
                <div class="">
                   ...
                   <input id="caption" value="" name="caption" type="text" placeholder="Enter event description" class="form-control input-md">
                </div>
             </div>
...
<script type="text/javascript">
	$(document).on("submit","#create_media",function()
	{
