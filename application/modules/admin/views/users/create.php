            ...
            <div class="box-body">
                <!-- <?php echo $form->open(); ?> -->
                    ...
                    <div class="form-line">
                        ...
                        <select id="university_school_id" name="university_school_id" class="university_schoo" >
                            ...
                            foreach ($university_schools as $ckey => $cvalue) {
                                $uni_schools = ($university_school == $cvalue['id'] ) ? "selected" : "";
                            ?>
                    ...
                    <div class="form-line">
                        ...
                        <input type="text" name="university_school" value="<?php echo $university_school ?>" placeholder="email address" id="university_school" class="form-control university_school" required>

                        <input type="text" name="university_school_email" value="" placeholder="Email address" id="university_school_email" class="form-control university_school_email" required disabled="">
                    </div>
                    ...
                    <div class="col-sm-12 submitt_edu">
                        <br>
                        <button type="submit" id="create_user" class="btn btn-primary update">Create</button>
...
<script type="text/javascript">
    $(document).on("click","#create_user",function()
    {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>admin/users/create",
